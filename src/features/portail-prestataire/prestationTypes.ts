...
export const TYPES_PRESTATION_LABELS = [
  ...
  { value: "Kinésithérapie & Cure thermale", label: "Kinésithérapie" },
  { value: "Maternité", label: "Maternité" },
  { value: "Transport", label: "Transport" },
  { value: "Autre", label: "Autre" },
];

// Rubriques de garanties (2026-08) — même taxonomie que Garantie.categorie
// (voir schema.prisma), utilisée pour configurer Prestataire.garantiesVisibles
// côté interne (écran Prestataires).
export const CATEGORIES_GARANTIES = ["Consultation/Divers", "Hospitalisation", "Dentisterie", "Optique", "Kinésithérapie & Cure thermale", "Maternité", "Transport", "Autre"];
